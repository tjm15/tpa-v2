...
import type {
	Policy, Site, Scenario, Goal, PlanDocument, SpatialDesignation,
...
let spatialDesignationIdCounter = 1;
let appIDC = { val: 1 };
...
const siteIDC = { val: 1 };
const spatialDesignationIDC = { val: 1 };
    ...
    return [
        {
            ...
            spatialDesignations: [ {id: 'con-1', name: 'Partially in AONB buffer zone', type: 'Landscape'}, {id: 'con-2', name: 'Flood Zone 1', type: 'Flood Risk'} ],
...
export function getMockSpatialDesignations(): SpatialDesignation[] {
    return [
        { id: generateId('sd', spatialDesignationIDC), name: 'Flood Zone 3', type: 'Flood Risk', severity: 'High', description: 'High probability of flooding.'},
        { id: generateId('sd', spatialDesignationIDC), name: 'Conservation Area', type: 'Heritage', severity: 'High', description: 'Statutory designation, special character to preserve/enhance.'},
        { id: generateId('sd', spatialDesignationIDC), name: 'Green Belt', type: 'Spatial Strategy', severity: 'High', description: 'Strong protection against inappropriate development.'},
        { id: generateId('sd', spatialDesignationIDC), name: 'Tree Preservation Order (TPO 123)', type: 'Amenity', severity: 'Medium', description: 'Specific group of trees protected.'},
    ];
}
    ...
    return [
        {
            ...
            spatialDesignations: site1?.spatialDesignations, // From the site or assessed separately
            relevantPolicies: [
...
export function getSiteAssessmentForDmMode(applicationId: string): SiteAssessmentResponse | null {
    ...
    return {
        ...
        constraints_affecting_site: app.spatialDesignations || [],
