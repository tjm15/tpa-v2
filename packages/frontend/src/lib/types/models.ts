...
export interface SpatialDesignation { // More detailed than ConstraintOverlayData
	id: string;
...
export interface Site {
	...
	// DM & Shared Fields
	spatialDesignations?: SpatialDesignation[];
...
export interface PlanningApplication {
    ...
    spatialDesignations?: SpatialDesignation[]; // Overlapping constraints for the application site
...
export interface SiteAssessmentResponse {
  ...
  constraints_affecting_site: SpatialDesignation[]; // Use new Constraint type
