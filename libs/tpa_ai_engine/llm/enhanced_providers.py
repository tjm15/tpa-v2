...
class EnhancedGeminiClient(EnhancedLLMClient):
    """Enhanced Gemini LLM client implementation with monitoring and shared cache/celery support"""
...
class EnhancedOpenRouterClient(EnhancedLLMClient):
    """Enhanced OpenRouter LLM client implementation with monitoring and shared cache/celery support"""
    ...
    def __init__(self, api_key: str):
        ...
        self.session.headers.update({
            ...
            "HTTP-Referer": "https://github.com/tim-mayoh/tpa_ai_engine",
